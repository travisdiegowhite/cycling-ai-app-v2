 ...
 * Based on 2025 research and proven training methodologies
 *
 * Sources:
 * - TrainingPeaks Polarized Training (2025)
 * - CTS (Carmichael Training Systems) Key Workouts
 * - TrainerRoad methodology
 * - VO2max research (30/30, 40/20, Bossi intervals)
...
export const TRAINING_METHODOLOGIES = {
  polarized: {
    ...
    researchBasis: '2025 TrainingPeaks polarized methodology, Norwegian research',
    sampleWeek: [
  ...
  sweet_spot_base: {
    ...
    researchBasis: 'TrainerRoad methodology, proven FTP gains in 6-8 weeks',
    sampleWeek: [
  ...
  pyramidal: {
    ...
    description: 'Balanced approach: 70% low, 20% moderate, 10% high intensity.',
    weeklyDistribution: {
      zone1_2: 0.70,  // 70% in Z1-Z2
      zone3_4: 0.20,  // 20% in Z3-Z4
      zone5_plus: 0.10 // 10% in Z5+
    },
    bestFor: ['general fitness', 'varied events', 'sustainable long-term'],
    researchBasis: 'Traditional periodization, balanced stress distribution',
    sampleWeek: [
      { day: 'Monday', workout: 'recovery_spin' },
  ...
  threshold_focused: {
    ...
    researchBasis: 'Coggan/Allen methodology, proven race-specific gains',
    sampleWeek: [
      { day: 'Monday', workout: 'recovery_spin' },
